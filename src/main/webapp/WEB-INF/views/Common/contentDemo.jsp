...
<!--sidebar-menu-->
    ...
    <ul>
        <li class="active"><a href="contentdemo.jsp"><i class="icon icon-home"></i> <span>Home</span></a></li>
...
<!--main-container-part-->
    ...
    <div id="content-header">
        <div id="breadcrumb">
            <a href="contentdemo.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
            Home</a>
        </div>
    </div>
    <!--End-breadcrumbs-->
